...
public class TicTacToe {
	...
	private void winningGame()
	{
		...
		{
			JOptionPane.showMessageDialog(frame, "Game drawn", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
	...
	private void initialize() {
		...
		JLabel lblPlayX = new JLabel("Player X");
		lblPlayX.setForeground(new Color(0, 0, 0));
		lblPlayX.setFont(new Font("Tahoma", Font.BOLD, 48));
		panel_4.add(lblPlayX, BorderLayout.CENTER);
		...
		xCount.setFont(new Font("Tahoma", Font.BOLD, 48));
		xCount.setText("0");
		...
		JLabel lblPlayO = new JLabel("Player O");
		lblPlayO.setForeground(Color.GRAY);
		lblPlayO.setFont(new Font("Tahoma", Font.BOLD, 48));
		panel_9.add(lblPlayO, BorderLayout.CENTER);
		...
		oCount.setForeground(Color.GRAY);
		oCount.setText("0");
		oCount.setFont(new Font("Tahoma", Font.BOLD, 48));
		...
		btnReset.setForeground(new Color(0, 255, 255));
		...
		panel_11.add(btnExit, BorderLayout.CENTER);
	}
